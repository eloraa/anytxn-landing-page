...
export const DesktopPattern = forwardRef<SVGSVGElement, PatternProps>(({ className, ...props }, ref) => {
  ...
  return (
    <svg ref={ref} className={className} width="1920" height="929" viewBox="0 0 1920 929" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <g id="hero-background-desktop">
        <g id="background" ref={backgroundRef}>
